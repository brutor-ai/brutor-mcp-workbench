...
export const TestableCapabilitiesList: React.FC<TestableCapabilitiesListProps> = ({
    ...
    // Check if all required parameters are filled for tools
    const areToolParamsValid = (tool: MCPTool, params: Record<string, any>): boolean => {
        if (!tool.inputSchema?.properties) {
            return true; // No parameters means tool can always run
        }
        ...
        return required.every(paramName => {
            ...
            const propDef = tool.inputSchema.properties[paramName];
                                ...
                                section.items.map((item: any, index: number) => {
                                    ...
                                    return (
                                        <div key={index} className="border rounded">
                                                ...
                                                <div className="flex items-start justify-between">
                                                    <div className="flex items-center space-x-2 flex-1 min-w-0">
                                                        ...
                                                        <button
                                                            ...
                                                            className="flex-shrink-0 text-gray-600 hover:text-primary-600"
                                                        >
                                                            {isExpanded ? (
                                                    ...
                                                    <div className="flex items-center space-x-1 ml-3">
                                                        {/* Settings/Parameters button for tools with parameters */}
                                                        {section.id === 'tools' && item.inputSchema?.properties && Object.keys(item.inputSchema.properties).length > 0 && (
                                                            <button
                                                                onClick={() => toggleItem(itemId)}
                                                        ...
                                                        {/* Settings/Parameters button for prompts with arguments */}
                                                        {section.id === 'prompts' && (() => {
                                                        ...
                                                        {/* Settings/Parameters button for resource templates */}
                                                        {section.id === 'resourceTemplates' && extractTemplateParams(item.uriTemplate).length > 0 && (
                                                            <button
                                                                onClick={() => toggleItem(itemId)}
                                                                className="btn-outline btn-small"
                                                                title="Configure template parameters"
                                                            >
                                                                <Settings className="w-3 h-3" />
                                                            </button>
                                                        )}
                                                        ...
                                                        <button
                                                            ...
                                                            disabled={
                                                                isTesting ||
                                                                (section.id === 'tools' && !areToolParamsValid(item, toolParams[itemId] || {})) ||
                                            ...
                                            {/* Expanded content with full details */}
                                            {isExpanded && (
                                                <div className="mt-3 pt-3 border-t bg-gray-50 rounded px-3 pb-3">
                                                    {/* Description */}
                                                            ...
                                                            <div className="mt-4 border-t pt-3">
                                                                <div className="flex items-center justify-between w-full mb-2">
                                                                    <button
                                                                        ...
                                                                        className="flex items-center space-x-2 text-xs font-medium text-gray-700 hover:text-primary-600"
                                                                    >
                                                                    ...
                                                                    <button
                                                                        ...
                                                                        className="text-primary-600 hover:text-blue-800 flex items-center space-x-1 text-xs"
                                                                    >
                                      ...
                                      {JSON.stringify(item, null, 2)}
                                                            ...
                                                            <div className="mt-3">
                                                                <button
                                                                    ...
                                                                    className="text-xs text-primary-600 hover:text-blue-800 flex items-center space-x-1"
                                                                >
                                                                    <Copy className="w-3 h-3" />
                                                                    <span>Copy URI</span>
                                                                </button>
