      ...
      case 'resource':
        if (data?.template) {
          ...
          return <div className="relative">
            ...
            <span className="absolute -top-1 -right-1 text-xs bg-primary-500 text-white rounded-full w-3 h-3 flex items-center justify-center font-bold">T</span>
          </div>;
        }
        // Regular resource
                      ...
                      <div className="mt-2">
                        ...
                        {attachment.type === 'resource' && attachment.data?.template && (
                          <div className="text-xs text-gray-700 bg-gray-50 p-2 rounded border mb-2">
                            ...
                            <div className="font-mono text-primary-600 mb-2">{attachment.data.template.uriTemplate}</div>
                        ...
                        {attachment.content.length > 150 && (
                          <button
                            ...
                            className="text-xs text-primary-600 hover:text-blue-800 mt-1 flex items-center space-x-1"
                          >
                            {isExpanded ? (
                              <>
