/*
 * Enhanced useMCPServers.ts with Connection Abort Support
 *
 * Key improvements:
 * 1. AbortController for canceling connection attempts
 * 2. Proper OAuth state cleanup on disconnect
...
export const useMCPServers = (): UseMCPServersReturn => {
    ...
    return {
        ...
        disconnectServer,
        disconnectAll,
        abortConnection, // NEW: Abort ongoing connections
        clearServerError,
